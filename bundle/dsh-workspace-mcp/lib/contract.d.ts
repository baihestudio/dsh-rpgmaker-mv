...
export declare function missingCriticalTools(names: readonly string[], engine: 'mv' | 'mz'): string[];
...
export declare function verifyManifest(engine: 'mv' | 'mz', manifest?: XeroloManifest | MzManifest): { errors: string[] };
export declare function validateDiscoveredTools(tools: DiscoveredTool[], engine: 'mv' | 'mz'): { errors: string[] };
