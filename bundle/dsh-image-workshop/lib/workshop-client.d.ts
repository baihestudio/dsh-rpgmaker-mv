...
export type WorkshopCleanupTimerScheduler = (callback: () => void, delayMs: number) => unknown;
...
export declare function setCleanupTimerScheduler(scheduler?: WorkshopCleanupTimerScheduler): void;
export declare function clearCleanupTimerScheduler(): void;
