...
export type WorkshopRunner = (bun: string, args: string[], env: Record<string, string | undefined>) => Promise<string>;
...
export declare function invokeImageOperation(operation: string, cliArgs: string[], env?: Record<string, string | undefined>): Promise<Record<string, unknown>>;
